...
const Dashboard = () => {
  ...
  const recentBookings = [
    ...
    { id: 3, customer: 'Lê Văn C', station: 'Trạm sạc Hải Châu', time: '16:00', status: 'completed' },
        { id: 3333333333333333333333333333333333333333333333333333, customer: 'Lê Văn f', station: 'Trạm sạc Hải Châu333333333333333333333333333333333', time: '16:00', status: 'completed' }
  ];
